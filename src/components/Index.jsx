    ...
    <div className='py-10 px-10'>
        <div className='grid md:grid-cols-2'>
            <div className='text-center'>
                ...
                <div><a href="https://drive.google.com/file/d/1wYX62HDPQKBnUxmzyzYSuJx8th0ZrtDO/view?usp=share_link"><button className='boton max-[900px]:m-1 max-[900px]:h-12 max-[900px]:rounded-3xl max-[900px]:w-80 mt-3'>Dowload CV</button></a></div>
            </div>
